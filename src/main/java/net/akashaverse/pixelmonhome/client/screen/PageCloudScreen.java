...
public class PageCloudScreen extends Screen {
    private final Screen parent; private int left, top;
    public PageCloudScreen(Screen parent) { super(Component.literal("Cloud")); this.parent = parent; }
