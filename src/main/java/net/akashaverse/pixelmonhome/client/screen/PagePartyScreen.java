...
public class PagePartyScreen extends Screen {
    private final Screen parent; private int left, top;
    public PagePartyScreen(Screen parent) { super(Component.literal("Party")); this.parent = parent; }
